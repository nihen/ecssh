...
GOOS=darwin GOARCH=arm64 go build -o dist/ecssh-macos-arm64 main.go

echo "Building for macOS Intel..."
GOOS=darwin GOARCH=amd64 go build -o dist/ecssh-macos-intel main.go
...
echo "  macOS ARM64 (Apple Silicon): ./dist/ecssh-macos-arm64"
echo "  macOS Intel:                 ./dist/ecssh-macos-intel"
